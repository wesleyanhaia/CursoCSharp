...
namespace Programacao_paralela_threads_2
{
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            /*/Na hora de criar uma thread, da pra fazer ela com um parametro, tipo começar ela de um numero
             * expecífico por exemplo, foi oq aconteceu nessa thread t2, a thread t2 começou pelo numero
             * 11. É bom lembrar que precisamos alterar o tipo de variavel para object (antes tava int)
             * na parte de criação de metodos, dai ficou assim :MinhaThreadComParametro(object inicioContador)
             * e depois colocar a variavel dnv pra int dai ficou assim (int)inicioContador;/*/
