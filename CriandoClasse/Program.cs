...
namespace CriandoClasses
{
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            CarroExterno meuCarroExterno = new CarroExterno(); /*/ Criei uma classe que fica em outro arquivo,
                                                                * se o namespace da classe for diferente do
                                                                * programa principal, temos que chamar a classe
                                                                * através de biblioteca com o using NomeDaClasse;/*/
        }
    }
}
